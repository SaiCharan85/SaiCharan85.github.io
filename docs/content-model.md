...
- `resume` is linked in multiple places. Sai's `ai-ml` profile points to `/Resume_AI_ML.pdf`; `datascientist` points to `/Resume_Data_Scientist.pdf`.
- Do not add phone or street address to visible site copy; public contact is privacy-light.
