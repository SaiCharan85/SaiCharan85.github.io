...
- `/`
  - Redirects to the default profile homepage at `/ai-ml`.
- `/:profileSlug`
...
- `/:profileSlug/project/:id`
  ...
  - Chooses the active profile's detail scene from `ProjectScenes.tsx`.
- `/project/:id`
  - Redirects legacy project URLs to `/ai-ml/project/:id` when the project exists in the default profile.
