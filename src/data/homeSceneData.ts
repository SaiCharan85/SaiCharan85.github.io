...
export const homeSceneData = {
  projects: {
    ...
    labels: [
      { label: "RAG", position: [-5.05, 2.45, -5.15], tone: "blue" },
      { label: "FAISS", position: [-4.7, 0.82, -4.05], tone: "amber" },
      { label: "PyTorch", position: [-1.7, 2.1, -1.45], tone: "emerald" },
      { label: "Airflow", position: [2.28, 1.38, 1.2], tone: "blue" },
      { label: "MLflow", position: [0.45, -1.42, 1.62], tone: "emerald" },
      { label: "Azure ML", position: [3.72, 1.78, 3.55], tone: "amber" },
      { label: "Bedrock", position: [3.2, 0.22, 4.45], tone: "blue" },
      { label: "LLMOps", position: [3.35, -1.28, 5.2], tone: "emerald" },
  ...
  experience: {
    ...
    labels: [
      ...
      { label: "Model Eval", position: [1.95, 2.04, 1.18], tone: "amber" },
      { label: "Monitoring", position: [3.88, 0.92, 3.58], tone: "blue" },
  ...
  education: {
    focalOffset: [0.08, -0.5, 0] as const,
    coreOffset: [0.05, -0.08, -3.2] as const,
    coreRotation: [0.04, -0.18, -0.04] as const,
    latticePlanes: [
      { position: [0.1, 0.14, -9.6], rotation: [1.18, 0.12, 0.06], size: [8.6, 3.5], tone: "scarlet" },
      { position: [0.2, -0.5, -3.8], rotation: [1.34, -0.08, -0.04], size: [5.8, 2.6], tone: "blue" },
    ] satisfies SceneFramePlane[],
    halos: [
      { position: [0.18, 0.34, -12.4], rotation: [1.14, 0.1, 0.05], radius: 4.2, tone: "scarlet" },
      { position: [-0.1, -0.18, -4.8], rotation: [1.28, -0.08, -0.1], radius: 2.65, tone: "blue" },
    ] satisfies SceneHalo[],
    ribbons: [
      {
        points: [
